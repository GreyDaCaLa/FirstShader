...
import GHK from '../../images/GreyHatKid.png'

const GHKtexture = new THREE.TextureLoader().load(GHK)

GHKtexture.magFilter = THREE.NearestFilter;
...
const WaveShaderMaterialFlyPaper = shaderMaterial(
    ...
    glsl`
        ...
        void main() {
            ...
            // gl_FragColor =vec4( uColor -pos.z*2.0    ,.5 );
        }
    `
)
